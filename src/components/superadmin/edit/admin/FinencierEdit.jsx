...
const FinenciereEdit = () => {
    ...
    const editAdmin = async (e) => {
        ...
        await axios({
            method: "post",
            url: "http://localhost:8000/api/superadmin/editFinancieres/" + id,
            data: formData,
            headers: {
        ...
        <div>
            <form onSubmit={editAdmin}>
                ...
                <div className="form form-container">
                    <h1>Modification d'admin financiere numero : {id}</h1>
                    <div className='message-controle'>
                        {
                            boolean ?
                                <div className='message'>{message} <NavLink to="/superadmin/finencier">Return</NavLink></div>
                                : ""
                        }
                    </div>
